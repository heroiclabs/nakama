...
type AchievementState int32

const (
	// The achievement is hidden from the player.
	AchievementState_HIDDEN AchievementState = 0
	// The player may see the achievement, but has not earned it yet.
	AchievementState_REVEALED AchievementState = 1
	// The player has earned the achievement.
	AchievementState_EARNED AchievementState = 2
)

var AchievementState_name = map[int32]string{
	0: "HIDDEN",
	1: "REVEALED",
	2: "EARNED",
}

var AchievementState_value = map[string]int32{
	"HIDDEN":   0,
	"REVEALED": 1,
	"EARNED":   2,
}
...
func (x AchievementState) String() string {
	return proto.EnumName(AchievementState_name, int32(x))
}

func (AchievementState) EnumDescriptor() ([]byte, []int) {
...
const (
	// Awarding achievement is manual (e.g. Completion of a story chapter).
	AchievementType_MANUAL AchievementType = 0
	// The Achievement tracks player progress towards a goal (e.g. Matches won).
	AchievementType_PROGRESSIVE AchievementType = 1
)
...
type AchievementRepeatability int32

const (
	// Achievement may not be earned multiple times.
	AchievementRepeatability_NOT_REPEATABLE AchievementRepeatability = 0
)

var AchievementRepeatability_name = map[int32]string{
	0: "NOT_REPEATABLE",
}

var AchievementRepeatability_value = map[string]int32{
	"NOT_REPEATABLE": 0,
}

func (x AchievementRepeatability) String() string {
	return proto.EnumName(AchievementRepeatability_name, int32(x))
}

func (AchievementRepeatability) EnumDescriptor() ([]byte, []int) {
...
func (UserGroupList_UserGroup_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_1b40cafcd4234784, []int{75, 0, 0}
}
...
func (*WriteLeaderboardRecordRequest_LeaderboardRecordWrite) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b40cafcd4234784, []int{77, 0}
}
...
func (m *Achievements) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Achievements.Unmarshal(m, b)
}
...
func (m *Achievements) XXX_Size() int {
	return xxx_messageInfo_Achievements.Size(m)
}
...
func (m *Achievements) GetAchievements() []*Achievement {
	if m != nil {
...
// List achievements for a given user
...
func (m *ListAchievementsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ListAchievementsRequest.Unmarshal(m, b)
}
...
func (m *ListAchievementsRequest) XXX_Size() int {
	return xxx_messageInfo_ListAchievementsRequest.Size(m)
}
...
func (m *ListAchievementsRequest) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
func (m *ListAchievementsRequest) GetCursor() string {
	if m != nil {
		return m.Cursor
	}
	return ""
...
type Achievement struct {
	// The unique identifier to reference this achievement.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The name of the achievement.
	Name string `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	// Description of the achievement.
	Description string `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"`
	// The state in which the achievement starts out.
	InitialState *wrappers.Int32Value `protobuf:"bytes,4,opt,name=initial_state,json=initialState,proto3" json:"initial_state,omitempty"`
	// Whether the achievement is awarded manually or progressed towards.
	Type *wrappers.Int32Value `protobuf:"bytes,5,opt,name=type,proto3" json:"type,omitempty"`
	// Whether an achievement can be earned multiple times. Currently only non-repeatable are supported.
	Repeatability *wrappers.Int32Value `protobuf:"bytes,6,opt,name=repeatability,proto3" json:"repeatability,omitempty"`
	// Progressive achievements get awarded once their progress surpass this value.
	TargetValue int64 `protobuf:"varint,7,opt,name=target_value,json=targetValue,proto3" json:"target_value,omitempty"`
	// URL for the image to be shown while the achievement is locked.
	LockedImageUrl string `protobuf:"bytes,8,opt,name=locked_image_url,json=lockedImageUrl,proto3" json:"locked_image_url,omitempty"`
	// URL for the image to be shown once the achievement was unlocked.
	UnlockedImageUrl string `protobuf:"bytes,9,opt,name=unlocked_image_url,json=unlockedImageUrl,proto3" json:"unlocked_image_url,omitempty"`
	// Auxiliary data field, which may be used by developers to store custom data.
	AuxiliaryData string `protobuf:"bytes,10,opt,name=auxiliary_data,json=auxiliaryData,proto3" json:"auxiliary_data,omitempty"`
	// Current progress towards the achievement.
	CurrentProgress      *AchievementProgress `protobuf:"bytes,11,opt,name=current_progress,json=currentProgress,proto3" json:"current_progress,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *Achievement) GetInitialState() *wrappers.Int32Value {
	if m != nil {
...
func (m *Achievement) GetType() *wrappers.Int32Value {
	if m != nil {
		return m.Type
	}
	return nil
...
func (m *Achievement) GetRepeatability() *wrappers.Int32Value {
	if m != nil {
...
func (m *Achievement) GetTargetValue() int64 {
	if m != nil {
...
func (m *Achievement) GetLockedImageUrl() string {
	if m != nil {
		return m.LockedImageUrl
	}
	return ""
}

func (m *Achievement) GetUnlockedImageUrl() string {
	if m != nil {
		return m.UnlockedImageUrl
	}
	return ""
}

func (m *Achievement) GetAuxiliaryData() string {
	if m != nil {
...
func (m *Achievement) GetCurrentProgress() *AchievementProgress {
	if m != nil {
...
// If a player made progress towards an achievement,
// an AchievementProgress is created representing their progress.
// If they never made progress towards an achievement, this will not be present.
type AchievementProgress struct {
	// Unique identifier of the achievement to which this progress belongs.
	AchievementId string `protobuf:"bytes,1,opt,name=achievement_id,json=achievementId,proto3" json:"achievement_id,omitempty"`
	// Unique identifier of the user that is progressing towards this achievement.
	UserId string `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	// Progress of the player towards the achievement.
	Progress int64 `protobuf:"varint,3,opt,name=progress,proto3" json:"progress,omitempty"`
	// Achievement state
	CurrentState *wrappers.Int32Value `protobuf:"bytes,4,opt,name=current_state,json=currentState,proto3" json:"current_state,omitempty"`
	// The UNIX time when the progress was created.
	CreatedAt *timestamp.Timestamp `protobuf:"bytes,5,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	// The UNIX time when the progress was last updated.
	UpdatedAt *timestamp.Timestamp `protobuf:"bytes,6,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`
	// The UNIX time when the progress was completed.
	AwardedAt *timestamp.Timestamp `protobuf:"bytes,7,opt,name=awarded_at,json=awardedAt,proto3" json:"awarded_at,omitempty"`
	// Auxiliary data field, may be used by developers to store player-specific data on achievement progress.
	AuxiliaryData        string   `protobuf:"bytes,8,opt,name=auxiliary_data,json=auxiliaryData,proto3" json:"auxiliary_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *AchievementProgress) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AchievementProgress.Unmarshal(m, b)
}
...
func (m *AchievementProgress) XXX_Size() int {
	return xxx_messageInfo_AchievementProgress.Size(m)
}
...
func (m *AchievementProgress) GetAchievementId() string {
	if m != nil {
...
func (m *AchievementProgress) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
func (m *AchievementProgress) GetProgress() int64 {
	if m != nil {
		return m.Progress
	}
	return 0
...
func (m *AchievementProgress) GetCurrentState() *wrappers.Int32Value {
	if m != nil {
...
func (m *AchievementProgress) GetCreatedAt() *timestamp.Timestamp {
	if m != nil {
		return m.CreatedAt
	}
	return nil
...
func (m *AchievementProgress) GetUpdatedAt() *timestamp.Timestamp {
	if m != nil {
		return m.UpdatedAt
	}
	return nil
...
func (m *AchievementProgress) GetAwardedAt() *timestamp.Timestamp {
	if m != nil {
		return m.AwardedAt
	}
	return nil
...
func (m *AchievementProgress) GetAuxiliaryData() string {
	if m != nil {
		return m.AuxiliaryData
	}
	return ""
...
// Used to update achievement progress.
...
func (m *AchievementProgressUpdate) Reset()         { *m = AchievementProgressUpdate{} }
func (m *AchievementProgressUpdate) String() string { return proto.CompactTextString(m) }
func (*AchievementProgressUpdate) ProtoMessage()    {}
func (*AchievementProgressUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b40cafcd4234784, []int{85}
}

func (m *AchievementProgressUpdate) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AchievementProgressUpdate.Unmarshal(m, b)
}
func (m *AchievementProgressUpdate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AchievementProgressUpdate.Marshal(b, m, deterministic)
}
func (m *AchievementProgressUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AchievementProgressUpdate.Merge(m, src)
}
func (m *AchievementProgressUpdate) XXX_Size() int {
	return xxx_messageInfo_AchievementProgressUpdate.Size(m)
}
func (m *AchievementProgressUpdate) XXX_DiscardUnknown() {
	xxx_messageInfo_AchievementProgressUpdate.DiscardUnknown(m)
}

var xxx_messageInfo_AchievementProgressUpdate proto.InternalMessageInfo

func (m *AchievementProgressUpdate) GetAchievementId() string {
	if m != nil {
		return m.AchievementId
	}
	return ""
...
func (m *AchievementProgressUpdate) GetProgress() int64 {
	if m != nil {
		return m.Progress
	}
	return 0
...
// Used to update auxiliary data of an achievement.
type AchievementAuxiliaryDataUpdate struct {
	// ID of the achievement to update.
	AchievementId string `protobuf:"bytes,1,opt,name=achievement_id,json=achievementId,proto3" json:"achievement_id,omitempty"`
	// Auxiliary data for the user.
	AuxiliaryData        string   `protobuf:"bytes,2,opt,name=auxiliary_data,json=auxiliaryData,proto3" json:"auxiliary_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *AchievementAuxiliaryDataUpdate) Reset()         { *m = AchievementAuxiliaryDataUpdate{} }
func (m *AchievementAuxiliaryDataUpdate) String() string { return proto.CompactTextString(m) }
func (*AchievementAuxiliaryDataUpdate) ProtoMessage()    {}
func (*AchievementAuxiliaryDataUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_1b40cafcd4234784, []int{86}
}

func (m *AchievementAuxiliaryDataUpdate) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AchievementAuxiliaryDataUpdate.Unmarshal(m, b)
}
func (m *AchievementAuxiliaryDataUpdate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AchievementAuxiliaryDataUpdate.Marshal(b, m, deterministic)
}
func (m *AchievementAuxiliaryDataUpdate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AchievementAuxiliaryDataUpdate.Merge(m, src)
}
func (m *AchievementAuxiliaryDataUpdate) XXX_Size() int {
	return xxx_messageInfo_AchievementAuxiliaryDataUpdate.Size(m)
}
func (m *AchievementAuxiliaryDataUpdate) XXX_DiscardUnknown() {
	xxx_messageInfo_AchievementAuxiliaryDataUpdate.DiscardUnknown(m)
}

var xxx_messageInfo_AchievementAuxiliaryDataUpdate proto.InternalMessageInfo

func (m *AchievementAuxiliaryDataUpdate) GetAchievementId() string {
	if m != nil {
		return m.AchievementId
	}
	return ""
...
func (m *AchievementAuxiliaryDataUpdate) GetAuxiliaryData() string {
	if m != nil {
		return m.AuxiliaryData
	}
	return ""
...
// Used to request information about an achievement.
type AchievementRequest struct {
	// ID of the achievement to fetch.
	AchievementId string `protobuf:"bytes,1,opt,name=achievement_id,json=achievementId,proto3" json:"achievement_id,omitempty"`
	// ID of the user whose progress should be fetched.
	UserId               string   `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *AchievementRequest) GetAchievementId() string {
	if m != nil {
		return m.AchievementId
	}
	return ""
...
func (m *AchievementRequest) GetUserId() string {
	if m != nil {
		return m.UserId
	}
	return ""
...
func init() {
	proto.RegisterEnum("nakama.api.AchievementState", AchievementState_name, AchievementState_value)
	proto.RegisterEnum("nakama.api.AchievementType", AchievementType_name, AchievementType_value)
	proto.RegisterEnum("nakama.api.AchievementRepeatability", AchievementRepeatability_name, AchievementRepeatability_value)
	...
	proto.RegisterType((*Achievements)(nil), "nakama.api.Achievements")
	proto.RegisterType((*ListAchievementsRequest)(nil), "nakama.api.ListAchievementsRequest")
	proto.RegisterType((*Achievement)(nil), "nakama.api.Achievement")
	proto.RegisterType((*AchievementProgress)(nil), "nakama.api.AchievementProgress")
	proto.RegisterType((*AchievementProgressUpdate)(nil), "nakama.api.AchievementProgressUpdate")
	proto.RegisterType((*AchievementAuxiliaryDataUpdate)(nil), "nakama.api.AchievementAuxiliaryDataUpdate")
	proto.RegisterType((*AchievementRequest)(nil), "nakama.api.AchievementRequest")
}
...
var fileDescriptor_1b40cafcd4234784 = []byte{
	...
	,
}
