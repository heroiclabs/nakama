...
const (
	...
	// If progress is updated and the update amount would result in
	// earning the achievement multiple times, the amount of achievements
	// earned is progress / target_value.
	AchievementRepeatability_AWARD_MULTIPLE_ON_OVERSHOOT AchievementRepeatability = 1
)

var AchievementRepeatability_name = map[int32]string{
	0: "NOT_REPEATABLE",
	1: "AWARD_MULTIPLE_ON_OVERSHOOT",
}

var AchievementRepeatability_value = map[string]int32{
	"NOT_REPEATABLE":              0,
	"AWARD_MULTIPLE_ON_OVERSHOOT": 1,
}
...
type Achievement struct {
	...
	// Whether an achievement can be earned multiple times + behaviour on earning.
	...
	// Amount of times the achievement was completed previously
	TimesAwarded int64 `protobuf:"varint,11,opt,name=times_awarded,json=timesAwarded,proto3" json:"times_awarded,omitempty"`
	// Current progress towards the achievement.
	CurrentProgress      *AchievementProgress `protobuf:"bytes,12,opt,name=current_progress,json=currentProgress,proto3" json:"current_progress,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *Achievement) GetTimesAwarded() int64 {
	if m != nil {
		return m.TimesAwarded
	}
	return 0
}
...
type AchievementProgress struct {
	// Unique identifier of this AchievementProgress.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	...
	// Achievement state
	CurrentState *wrappers.Int32Value `protobuf:"bytes,5,opt,name=current_state,json=currentState,proto3" json:"current_state,omitempty"`
	// The UNIX time when the progress was completed.
	AwardedAt *timestamp.Timestamp `protobuf:"bytes,6,opt,name=awarded_at,json=awardedAt,proto3" json:"awarded_at,omitempty"`
	// Auxiliary data field, may be used by developers to store player-specific data on achievement progress.
	AuxiliaryData        string   `protobuf:"bytes,7,opt,name=auxiliary_data,json=auxiliaryData,proto3" json:"auxiliary_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *AchievementProgress) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
// Used to update simple achievements, where just simple progress is made.
type AchievementProgressUpdate struct {
	...
	// Progress to add to the achievement
...
var fileDescriptor_1b40cafcd4234784 = []byte{
	...
	,
}
