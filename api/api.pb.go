...
func (m *AchievementList) GetAchievements() []*Achievement {
	if m != nil {
...
type Achievement struct {
	...
	InitialState AchievementState `protobuf:"varint,4,opt,name=initial_state,json=initialState,proto3,enum=nakama.api.AchievementState" json:"initial_state,omitempty"`
	// Whether the achievement is awarded manually or progressed towards.
	Type AchievementType `protobuf:"varint,5,opt,name=type,proto3,enum=nakama.api.AchievementType" json:"type,omitempty"`
	// Whether an achievement can be earned multiple times + behaviour on earning.
	Repeatability AchievementRepeatability `protobuf:"varint,6,opt,name=repeatability,proto3,enum=nakama.api.AchievementRepeatability" json:"repeatability,omitempty"`
	...
	// Progress made towards the achievement. Multiple may be set if the achievement is
	// earned multiple times.
	Progress             []*AchievementProgress `protobuf:"bytes,11,rep,name=progress,proto3" json:"progress,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *Achievement) GetInitialState() AchievementState {
	if m != nil {
		return m.InitialState
	}
	return AchievementState_HIDDEN
}

func (m *Achievement) GetType() AchievementType {
	if m != nil {
		return m.Type
	}
	return AchievementType_MANUAL
}

func (m *Achievement) GetRepeatability() AchievementRepeatability {
	if m != nil {
		return m.Repeatability
	}
	return AchievementRepeatability_NOT_REPEATABLE
}
...
func (m *Achievement) GetProgress() []*AchievementProgress {
	if m != nil {
		return m.Progress
	}
	return nil
...
type AchievementProgress struct {
	...
	// Achievement state
	CurrentState AchievementState `protobuf:"varint,4,opt,name=current_state,json=currentState,proto3,enum=nakama.api.AchievementState" json:"current_state,omitempty"`
	// The UNIX time when the progress was completed.
	AwardedAt *timestamp.Timestamp `protobuf:"bytes,5,opt,name=awarded_at,json=awardedAt,proto3" json:"awarded_at,omitempty"`
	// Auxiliary data field, may be used by developers to store player-specific data on achievement progress.
	AuxiliaryData        string   `protobuf:"bytes,6,opt,name=auxiliary_data,json=auxiliaryData,proto3" json:"auxiliary_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *AchievementProgress) GetCurrentState() AchievementState {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*AchievementList)(nil), "nakama.api.AchievementList")
...
var fileDescriptor_1b40cafcd4234784 = []byte{
	...
	,
}
