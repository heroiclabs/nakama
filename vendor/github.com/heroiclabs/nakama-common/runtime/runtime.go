...
type NakamaModule interface {
	...
	// ReceiptList(ctx context.Context, limit int, cursor string) (*api.ValidatePurchaseResponse, error)
	// ReceiptGetByTransactionID(ctx context.Context, transactionID string) (string, *api.ValidatePurchaseResponse_ValidatedPurchase, error)
