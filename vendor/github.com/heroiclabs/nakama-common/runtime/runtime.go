...
type Initializer interface {
	...
	*/
	...
	// RegisterBeforeValidatePurchaseFBInstant can be used to perform additional logic before validating an FB Instant IAP receipt.
	RegisterBeforeValidatePurchaseFBInstant(fn func(ctx context.Context, logger Logger, db *sql.DB, nk NakamaModule, in *api.ValidatePurchaseFBInstantRequest) (*api.ValidatePurchaseFBInstantRequest, error)) error

	// RegisterAfterValidatePurchaseFBInstant can be used to perform additional logic after validating an FB Instant IAP receipt.
	RegisterAfterValidatePurchaseFBInstant(fn func(ctx context.Context, logger Logger, db *sql.DB, nk NakamaModule, out *api.ValidatePurchaseResponse, in *api.ValidatePurchaseFBInstantRequest) error) error
...
type NakamaModule interface {
	...
	PurchaseValidateFBInstant(ctx context.Context, userID, signedRequest string, persist bool) (*api.ValidatePurchaseResponse, error)
