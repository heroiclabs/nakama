...
// Apple StoreKit2 JWS Purchase validation request
type ValidatePurchaseAppleJWSRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The JWS token from StoreKit2 (jwsRepresentation).
...
func (x *ValidatePurchaseAppleJWSRequest) Reset() {
	*x = ValidatePurchaseAppleJWSRequest{}
	mi := &file_api_proto_msgTypes[99]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ValidatePurchaseAppleJWSRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValidatePurchaseAppleJWSRequest) ProtoMessage() {}

func (x *ValidatePurchaseAppleJWSRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[99]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValidatePurchaseAppleJWSRequest.ProtoReflect.Descriptor instead.
func (*ValidatePurchaseAppleJWSRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{99}
}

func (x *ValidatePurchaseAppleJWSRequest) GetJws() string {
	if x != nil {
		return x.Jws
	}
	return ""
...
func (x *ValidatePurchaseAppleJWSRequest) GetPersist() *wrapperspb.BoolValue {
	if x != nil {
		return x.Persist
	}
	return nil
...
// Apple StoreKit2 JWS Subscription validation request
type ValidateSubscriptionAppleJWSRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The JWS token from StoreKit2 (jwsRepresentation).
	Jws string `protobuf:"bytes,1,opt,name=jws,proto3" json:"jws,omitempty"`
	// Persist the subscription.
...
func (x *ValidateSubscriptionAppleJWSRequest) Reset() {
	*x = ValidateSubscriptionAppleJWSRequest{}
	mi := &file_api_proto_msgTypes[100]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ValidateSubscriptionAppleJWSRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ValidateSubscriptionAppleJWSRequest) ProtoMessage() {}

func (x *ValidateSubscriptionAppleJWSRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_msgTypes[100]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ValidateSubscriptionAppleJWSRequest.ProtoReflect.Descriptor instead.
func (*ValidateSubscriptionAppleJWSRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_rawDescGZIP(), []int{100}
}

func (x *ValidateSubscriptionAppleJWSRequest) GetJws() string {
	if x != nil {
		return x.Jws
	}
	return ""
...
func (x *ValidateSubscriptionAppleJWSRequest) GetPersist() *wrapperspb.BoolValue {
	if x != nil {
		return x.Persist
	}
	return nil
...
const file_api_proto_rawDesc = "" +
	...
	"\areceipt\x18\x01 \x01(\tR\areceipt\x124\n" +
	"\apersist\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\apersist\"i\n" +
	"\x1fValidatePurchaseAppleJWSRequest\x12\x10\n" +
	"\x03jws\x18\x01 \x01(\tR\x03jws\x124\n" +
	"\apersist\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\apersist\"m\n" +
	"#ValidateSubscriptionAppleJWSRequest\x12\x10\n" +
	"\x03jws\x18\x01 \x01(\tR\x03jws\x124\n" +
...
var file_api_proto_goTypes = []any{
	...
	(*ValidatePurchaseAppleJWSRequest)(nil),          // 105: nakama.api.ValidatePurchaseAppleJWSRequest
	(*ValidateSubscriptionAppleJWSRequest)(nil),      // 106: nakama.api.ValidateSubscriptionAppleJWSRequest
...
var file_api_proto_depIdxs = []int32{
	...
	142, // 144: nakama.api.ValidatePurchaseAppleJWSRequest.persist:type_name -> google.protobuf.BoolValue
	142, // 145: nakama.api.ValidateSubscriptionAppleJWSRequest.persist:type_name -> google.protobuf.BoolValue
	...
	141, // 159: nakama.api.ValidatedSubscription.purchase_time:type_name -> google.protobuf.Timestamp
	141, // 160: nakama.api.ValidatedSubscription.create_time:type_name -> google.protobuf.Timestamp
	141, // 161: nakama.api.ValidatedSubscription.update_time:type_name -> google.protobuf.Timestamp
	1,   // 162: nakama.api.ValidatedSubscription.environment:type_name -> nakama.api.StoreEnvironment
	141, // 163: nakama.api.ValidatedSubscription.expiry_time:type_name -> google.protobuf.Timestamp
	141, // 164: nakama.api.ValidatedSubscription.refund_time:type_name -> google.protobuf.Timestamp
	...
	139, // 167: nakama.api.WriteLeaderboardRecordRequest.record:type_name -> nakama.api.WriteLeaderboardRecordRequest.LeaderboardRecordWrite
	143, // 168: nakama.api.WriteStorageObject.permission_read:type_name -> google.protobuf.Int32Value
	143, // 169: nakama.api.WriteStorageObject.permission_write:type_name -> google.protobuf.Int32Value
	118, // 170: nakama.api.WriteStorageObjectsRequest.objects:type_name -> nakama.api.WriteStorageObject
	140, // 171: nakama.api.WriteTournamentRecordRequest.record:type_name -> nakama.api.WriteTournamentRecordRequest.TournamentRecordWrite
	143, // 172: nakama.api.ListPartiesRequest.limit:type_name -> google.protobuf.Int32Value
	142, // 173: nakama.api.ListPartiesRequest.open:type_name -> google.protobuf.BoolValue
	144, // 174: nakama.api.ListPartiesRequest.query:type_name -> google.protobuf.StringValue
	144, // 175: nakama.api.ListPartiesRequest.cursor:type_name -> google.protobuf.StringValue
	122, // 176: nakama.api.PartyList.parties:type_name -> nakama.api.Party
	100, // 177: nakama.api.FriendsOfFriendsList.FriendOfFriend.user:type_name -> nakama.api.User
	100, // 178: nakama.api.GroupUserList.GroupUser.user:type_name -> nakama.api.User
	143, // 179: nakama.api.GroupUserList.GroupUser.state:type_name -> google.protobuf.Int32Value
	48,  // 180: nakama.api.UserGroupList.UserGroup.group:type_name -> nakama.api.Group
	143, // 181: nakama.api.UserGroupList.UserGroup.state:type_name -> google.protobuf.Int32Value
	2,   // 182: nakama.api.WriteLeaderboardRecordRequest.LeaderboardRecordWrite.operator:type_name -> nakama.api.Operator
	2,   // 183: nakama.api.WriteTournamentRecordRequest.TournamentRecordWrite.operator:type_name -> nakama.api.Operator
