...
func (*GenerateAccessTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{0}
}
...
func (*GenerateAccessTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{1}
}
...
func (*SignBlobRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{2}
}
...
func (*SignBlobResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{3}
}
...
func (*SignJwtRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{4}
}
...
func (*SignJwtResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{5}
}
...
func (*GenerateIdTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{6}
}
...
func (*GenerateIdTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{7}
}
...
func (*GenerateIdentityBindingAccessTokenRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{8}
}
...
func (*GenerateIdentityBindingAccessTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_8cf8a86b4991d464, []int{9}
}
...
func init() {
	proto.RegisterFile("google/iam/credentials/v1/common.proto", fileDescriptor_common_8cf8a86b4991d464)
}

var fileDescriptor_common_8cf8a86b4991d464 = []byte{
