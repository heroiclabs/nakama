...
func init() {
	proto.RegisterFile("google/iam/credentials/v1/iamcredentials.proto", fileDescriptor_iamcredentials_c860f4c52834cce8)
}

var fileDescriptor_iamcredentials_c860f4c52834cce8 = []byte{
