...
const (
	...
	Nakama_ValidatePurchaseFBInstant_FullMethodName         = "/nakama.api.Nakama/ValidatePurchaseFBInstant"
...
type NakamaClient interface {
	...
	ValidatePurchaseFBInstant(ctx context.Context, in *api.ValidatePurchaseFBInstantRequest, opts ...grpc.CallOption) (*api.ValidatePurchaseResponse, error)
...
func (c *nakamaClient) ValidatePurchaseFBInstant(ctx context.Context, in *api.ValidatePurchaseFBInstantRequest, opts ...grpc.CallOption) (*api.ValidatePurchaseResponse, error) {
	out := new(api.ValidatePurchaseResponse)
	err := c.cc.Invoke(ctx, Nakama_ValidatePurchaseFBInstant_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NakamaServer interface {
	...
	// Validate FB Instant IAP Receipt
	ValidatePurchaseFBInstant(context.Context, *api.ValidatePurchaseFBInstantRequest) (*api.ValidatePurchaseResponse, error)
	// Write a record to a leaderboard.
...
func (UnimplementedNakamaServer) ValidatePurchaseFBInstant(context.Context, *api.ValidatePurchaseFBInstantRequest) (*api.ValidatePurchaseResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidatePurchaseFBInstant not implemented")
}
...
func _Nakama_ValidatePurchaseFBInstant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.ValidatePurchaseFBInstantRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NakamaServer).ValidatePurchaseFBInstant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Nakama_ValidatePurchaseFBInstant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NakamaServer).ValidatePurchaseFBInstant(ctx, req.(*api.ValidatePurchaseFBInstantRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Nakama_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ValidatePurchaseFBInstant",
			Handler:    _Nakama_ValidatePurchaseFBInstant_Handler,
		},
		{
