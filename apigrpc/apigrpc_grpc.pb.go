...
func (c *nakamaClient) Authenticate(ctx context.Context, in *api.AuthenticateRequest, opts ...grpc.CallOption) (*api.Session, error) {
	out := new(api.Session)
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/Authenticate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) GetMatchmakerStats(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*api.MatchmakerStats, error) {
	...
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/GetMatchmakerStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) Link(ctx context.Context, in *api.AccountProvider, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/Link", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) ListFriendsOfFriends(ctx context.Context, in *api.ListFriendsOfFriendsRequest, opts ...grpc.CallOption) (*api.FriendsOfFriendsList, error) {
	...
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/ListFriendsOfFriends", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) ListParties(ctx context.Context, in *api.ListPartiesRequest, opts ...grpc.CallOption) (*api.PartyList, error) {
	...
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/ListParties", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) Unlink(ctx context.Context, in *api.AccountProvider, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/Unlink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) ValidatePurchaseFacebookInstant(ctx context.Context, in *api.ValidatePurchaseFacebookInstantRequest, opts ...grpc.CallOption) (*api.ValidatePurchaseResponse, error) {
	out := new(api.ValidatePurchaseResponse)
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/ValidatePurchaseFacebookInstant", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) ValidatePurchaseSamsung(ctx context.Context, in *api.ValidatePurchaseSamsungRequest, opts ...grpc.CallOption) (*api.ValidatePurchaseResponse, error) {
	out := new(api.ValidatePurchaseResponse)
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/ValidatePurchaseSamsung", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Nakama_Authenticate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/Authenticate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Nakama_GetMatchmakerStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/GetMatchmakerStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Nakama_Link_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/Link",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Nakama_ListFriendsOfFriends_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/ListFriendsOfFriends",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Nakama_ListParties_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/ListParties",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Nakama_Unlink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/Unlink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Nakama_ValidatePurchaseFacebookInstant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/ValidatePurchaseFacebookInstant",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Nakama_ValidatePurchaseSamsung_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/ValidatePurchaseSamsung",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
