...
type NakamaClient interface {
	...
	// Authenticate a user with Itch against the server.
	AuthenticateItch(ctx context.Context, in *api.AuthenticateItchRequest, opts ...grpc.CallOption) (*api.Session, error)
	...
	// Add Itch to the social profiles on the current user's account.
	LinkItch(ctx context.Context, in *api.AccountItch, opts ...grpc.CallOption) (*empty.Empty, error)
	...
	// Remove Itch from the social profiles on the current user's account.
	UnlinkItch(ctx context.Context, in *api.AccountItch, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *nakamaClient) AuthenticateItch(ctx context.Context, in *api.AuthenticateItchRequest, opts ...grpc.CallOption) (*api.Session, error) {
	out := new(api.Session)
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/AuthenticateItch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) LinkItch(ctx context.Context, in *api.AccountItch, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/LinkItch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) UnlinkItch(ctx context.Context, in *api.AccountItch, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/nakama.api.Nakama/UnlinkItch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NakamaServer interface {
	...
	// Authenticate a user with Itch against the server.
	AuthenticateItch(context.Context, *api.AuthenticateItchRequest) (*api.Session, error)
	// Ban a set of users from a group.
	...
	// Add Itch to the social profiles on the current user's account.
	LinkItch(context.Context, *api.AccountItch) (*empty.Empty, error)
	// List a channel's message history.
	...
	// Remove Itch from the social profiles on the current user's account.
	UnlinkItch(context.Context, *api.AccountItch) (*empty.Empty, error)
	// Update fields in the current user's account.
...
func (UnimplementedNakamaServer) AuthenticateItch(context.Context, *api.AuthenticateItchRequest) (*api.Session, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthenticateItch not implemented")
}
...
func (UnimplementedNakamaServer) LinkItch(context.Context, *api.AccountItch) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LinkItch not implemented")
}
...
func (UnimplementedNakamaServer) UnlinkItch(context.Context, *api.AccountItch) (*empty.Empty, error) {
...
func _Nakama_AuthenticateItch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.AuthenticateItchRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NakamaServer).AuthenticateItch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/AuthenticateItch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NakamaServer).AuthenticateItch(ctx, req.(*api.AuthenticateItchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Nakama_LinkItch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.AccountItch)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NakamaServer).LinkItch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/LinkItch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NakamaServer).LinkItch(ctx, req.(*api.AccountItch))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Nakama_UnlinkItch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.AccountItch)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NakamaServer).UnlinkItch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.api.Nakama/UnlinkItch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NakamaServer).UnlinkItch(ctx, req.(*api.AccountItch))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Nakama_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AuthenticateItch",
			Handler:    _Nakama_AuthenticateItch_Handler,
		},
		{
		...
		{
			MethodName: "LinkItch",
			Handler:    _Nakama_LinkItch_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _Nakama_UnlinkItch_Handler,
		},
		{
