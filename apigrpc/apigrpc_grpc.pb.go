...
const (
	...
	Nakama_ValidatePurchaseAppleJWS_FullMethodName          = "/nakama.api.Nakama/ValidatePurchaseAppleJWS"
	Nakama_ValidateSubscriptionAppleJWS_FullMethodName      = "/nakama.api.Nakama/ValidateSubscriptionAppleJWS"
...
type NakamaClient interface {
	...
	// Validate Apple StoreKit2 JWS Purchase
	ValidatePurchaseAppleJWS(ctx context.Context, in *api.ValidatePurchaseAppleJWSRequest, opts ...grpc.CallOption) (*api.ValidatePurchaseResponse, error)
	// Validate Apple StoreKit2 JWS Subscription
	ValidateSubscriptionAppleJWS(ctx context.Context, in *api.ValidateSubscriptionAppleJWSRequest, opts ...grpc.CallOption) (*api.ValidateSubscriptionResponse, error)
...
func (c *nakamaClient) ValidatePurchaseAppleJWS(ctx context.Context, in *api.ValidatePurchaseAppleJWSRequest, opts ...grpc.CallOption) (*api.ValidatePurchaseResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.ValidatePurchaseResponse)
	err := c.cc.Invoke(ctx, Nakama_ValidatePurchaseAppleJWS_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *nakamaClient) ValidateSubscriptionAppleJWS(ctx context.Context, in *api.ValidateSubscriptionAppleJWSRequest, opts ...grpc.CallOption) (*api.ValidateSubscriptionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(api.ValidateSubscriptionResponse)
	err := c.cc.Invoke(ctx, Nakama_ValidateSubscriptionAppleJWS_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NakamaServer interface {
	...
	// Validate Apple StoreKit2 JWS Purchase
	ValidatePurchaseAppleJWS(context.Context, *api.ValidatePurchaseAppleJWSRequest) (*api.ValidatePurchaseResponse, error)
	// Validate Apple StoreKit2 JWS Subscription
	ValidateSubscriptionAppleJWS(context.Context, *api.ValidateSubscriptionAppleJWSRequest) (*api.ValidateSubscriptionResponse, error)
	// Validate Google IAP Receipt
...
func (UnimplementedNakamaServer) ValidatePurchaseAppleJWS(context.Context, *api.ValidatePurchaseAppleJWSRequest) (*api.ValidatePurchaseResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ValidatePurchaseAppleJWS not implemented")
}
func (UnimplementedNakamaServer) ValidateSubscriptionAppleJWS(context.Context, *api.ValidateSubscriptionAppleJWSRequest) (*api.ValidateSubscriptionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ValidateSubscriptionAppleJWS not implemented")
}
...
func _Nakama_ValidatePurchaseAppleJWS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.ValidatePurchaseAppleJWSRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NakamaServer).ValidatePurchaseAppleJWS(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Nakama_ValidatePurchaseAppleJWS_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NakamaServer).ValidatePurchaseAppleJWS(ctx, req.(*api.ValidatePurchaseAppleJWSRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Nakama_ValidateSubscriptionAppleJWS_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.ValidateSubscriptionAppleJWSRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NakamaServer).ValidateSubscriptionAppleJWS(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Nakama_ValidateSubscriptionAppleJWS_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NakamaServer).ValidateSubscriptionAppleJWS(ctx, req.(*api.ValidateSubscriptionAppleJWSRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Nakama_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ValidatePurchaseAppleJWS",
			Handler:    _Nakama_ValidatePurchaseAppleJWS_Handler,
		},
		{
			MethodName: "ValidateSubscriptionAppleJWS",
			Handler:    _Nakama_ValidateSubscriptionAppleJWS_Handler,
		},
		{
