...
CREATE TABLE IF NOT EXISTS leaderboard (
    PRIMARY KEY (id, owner_id, expires_at),
    FOREIGN KEY (id) REFERENCES leaderboard_metadata(id) ON DELETE CASCADE,
    id         BYTEA        NOT NULL,
...
CREATE INDEX IF NOT EXISTS id_idx ON leaderboard (id); -- TODO make multi-column

-- +migrate Down
DROP TABLE IF EXISTS leaderboard;
DROP TABLE IF EXISTS leaderboard_metadata;
