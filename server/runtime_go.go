...
func (ri *RuntimeGoInitializer) RegisterHiro(module any) error {
	h, ok := module.(hiro.Hiro)
	if !ok {
		return errors.New("module does not implement hiro.Hiro interface")
	}
