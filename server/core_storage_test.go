...
func TestStorageWriteRuntimeGlobalSingle(t *testing.T) {
	...
	acks, code, err := StorageWriteObjects(context.Background(), logger, db, metrics, s.storageIndex, true, ops)
...
func TestStorageWriteRuntimeUserMultiple(t *testing.T) {
	...
	acks, code, err := StorageWriteObjects(context.Background(), logger, db, metrics, s.storageIndex, false, ops)
...
func TestStorageWriteRuntimeGlobalSingleIfNoneMatchNotExists(t *testing.T) {
	...
	acks, _, err := StorageWriteObjects(context.Background(), logger, db, metrics, s.storageIndex, true, ops)
...
func TestStorageWritePipelineUserSingle(t *testing.T) {
	...
	acks, _, err := StorageWriteObjects(context.Background(), logger, db, metrics, s.storageIndex, false, ops)
...
func TestStorageWritePipelineUserMultiple(t *testing.T) {
	...
	allAcks, code, err := StorageWriteObjects(context.Background(), logger, db, metrics, s.storageIndex, false, ops)
	if err != nil {
		t.Fatal(err.Error())
	}
	acks := allAcks.Acks
...
func TestStorageRemoveRuntimeGlobalPublic(t *testing.T) {
	...
	_, err = StorageDeleteObjects(context.Background(), logger, db, s.storageIndex, true, deleteOps)
	assert.Nil(t, err, "err was not nil")
}
...
func TestStorageRemovePipelineUserDenied(t *testing.T) {
	...
	code, err = StorageDeleteObjects(context.Background(), logger, db, s.storageIndex, false, deleteOps)
	assert.NotNil(t, err, "err was nil")
...
func TestStorageRemoveRuntimeGlobalIfMatchNotExists(t *testing.T) {
	...
	code, err := StorageDeleteObjects(context.Background(), logger, db, s.storageIndex, true, deleteOps)
	assert.NotNil(t, err, "err was nil")
	assert.Equal(t, code, codes.InvalidArgument, "code did not match InvalidArgument.")
}
