...
type RuntimeConfig struct {
	...
	LuaModuleHotfix    bool              `yaml:"lua_module_hotfix" json:"lua_module_hotfix" usage:"When enabled marks modules can be hotfix through server side rpc. Default true."`
