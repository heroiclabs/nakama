...
**YOU ARE IN: `nakama/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/nakama/` (rig root) or other directories
...
**Your mail address:** `nakama/polecats/obsidian`
**Your rig:** nakama
**Your Witness:** `nakama/witness`
...
| Ask Witness for help | `gt mail send nakama/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`nakama/witness`) when:
...
```bash
gt mail send nakama/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
