...
var InitModule = function (ctx, logger, nk, initializer) {
    ...
    try {
        nk.groupUsersAdd('27b72ae3-613b-4787-8c3b-3f26e95de0d0', ['625dd165-3523-4ac9-afe0-82e2b489e8d1'], 'b37d3075-5086-425a-baf2-511b89e9ac3b');
    }
    catch (error) {
        logger.error('Error adding user to group: %s', error.message);
    }
};
