...
The Copilot module extends Nakama with advanced leaderboard and social features:
...
- **[Unity Integration Guide](./UNITY_INTEGRATION_GUIDE.md)** - Complete C# examples and best practices
