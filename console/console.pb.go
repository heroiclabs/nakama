...
const (
	...
	AclResources_HIRO_STREAKS        AclResources = 30
)
...
var file_console_proto_msgTypes = make([]protoimpl.MessageInfo, 143)
var file_console_proto_goTypes = []any{
	...
	(*Template_View)(nil),                                   // 129: nakama.console.Template.View
	(*Template_Export)(nil),                                 // 130: nakama.console.Template.Export
	(*Template_VariantExport)(nil),                          // 131: nakama.console.Template.VariantExport
	(*Template_ListRequest)(nil),                            // 132: nakama.console.Template.ListRequest
	(*Template_SingleTextValueFilterOption)(nil),            // 133: nakama.console.Template.SingleTextValueFilterOption
	(*Template_ListResponse)(nil),                           // 134: nakama.console.Template.ListResponse
	(*Template_CreateRequest)(nil),                          // 135: nakama.console.Template.CreateRequest
	(*Template_UpdateRequest)(nil),                          // 136: nakama.console.Template.UpdateRequest
	(*Template_PageOptions)(nil),                            // 137: nakama.console.Template.PageOptions
	(*Template_ListRequest_SearchOptions)(nil),              // 138: nakama.console.Template.ListRequest.SearchOptions
	(*Template_ListRequest_MultiTextValueFilterOption)(nil), // 139: nakama.console.Template.ListRequest.MultiTextValueFilterOption
	(*Template_ListRequest_PaginationOptions)(nil),          // 140: nakama.console.Template.ListRequest.PaginationOptions
	(*Category_Export)(nil),                                 // 141: nakama.console.Category.Export
	(*Category_View)(nil),                                   // 142: nakama.console.Category.View
	nil,                                                     // 143: nakama.console.SendDirectMessageRequest.ChannelsEntry
	(*SendDirectMessageRequest_TemplateOverride)(nil),       // 144: nakama.console.SendDirectMessageRequest.TemplateOverride
	(*SendDirectMessageRequest_MessageChannels)(nil),        // 145: nakama.console.SendDirectMessageRequest.MessageChannels
	nil, // 146: nakama.console.SendDirectMessageRequest.TemplateOverride.VariantsEntry
	(*SendDirectMessageResponse_DeliveryResult)(nil),                   // 147: nakama.console.SendDirectMessageResponse.DeliveryResult
	(*SendDirectMessageResponse_DeliveryResult_IntegrationResult)(nil), // 148: nakama.console.SendDirectMessageResponse.DeliveryResult.IntegrationResult
	(*MessageIntegration_Export)(nil),                                  // 149: nakama.console.MessageIntegration.Export
	(*api.Account)(nil),                                                // 150: nakama.api.Account
	(*timestamppb.Timestamp)(nil),                                      // 151: google.protobuf.Timestamp
	(*wrapperspb.BoolValue)(nil),                                       // 152: google.protobuf.BoolValue
	(*api.StorageObject)(nil),                                          // 153: nakama.api.StorageObject
	(*api.Friend)(nil),                                                 // 154: nakama.api.Friend
	(*api.Group)(nil),                                                  // 155: nakama.api.Group
	(*api.ChannelMessage)(nil),                                         // 156: nakama.api.ChannelMessage
	(*api.LeaderboardRecord)(nil),                                      // 157: nakama.api.LeaderboardRecord
	(*api.Notification)(nil),                                           // 158: nakama.api.Notification
	(*api.User)(nil),                                                   // 159: nakama.api.User
	(*wrapperspb.Int32Value)(nil),                                      // 160: google.protobuf.Int32Value
	(*api.GroupUserList_GroupUser)(nil),                                // 161: nakama.api.GroupUserList.GroupUser
	(*wrapperspb.StringValue)(nil),                                     // 162: google.protobuf.StringValue
	(*rtapi.UserPresence)(nil),                                         // 163: nakama.realtime.UserPresence
	(*structpb.Struct)(nil),                                            // 164: google.protobuf.Struct
	(*api.Match)(nil),                                                  // 165: nakama.api.Match
	(*emptypb.Empty)(nil),                                              // 166: google.protobuf.Empty
	(*api.ReadStorageObjectId)(nil),                                    // 167: nakama.api.ReadStorageObjectId
	(*api.ListLeaderboardRecordsRequest)(nil),                          // 168: nakama.api.ListLeaderboardRecordsRequest
	(*api.FriendList)(nil),                                             // 169: nakama.api.FriendList
	(*api.GroupUserList)(nil),                                          // 170: nakama.api.GroupUserList
	(*api.UserGroupList)(nil),                                          // 171: nakama.api.UserGroupList
	(*api.ValidatedPurchase)(nil),                                      // 172: nakama.api.ValidatedPurchase
	(*api.ValidatedSubscription)(nil),                                  // 173: nakama.api.ValidatedSubscription
	(*api.LeaderboardRecordList)(nil),                                  // 174: nakama.api.LeaderboardRecordList
	(*api.ChannelMessageList)(nil),                                     // 175: nakama.api.ChannelMessageList
	(*api.PurchaseList)(nil),                                           // 176: nakama.api.PurchaseList
	(*api.SubscriptionList)(nil),                                       // 177: nakama.api.SubscriptionList
	(*api.StorageObjectAck)(nil),                                       // 178: nakama.api.StorageObjectAck
}
var file_console_proto_depIdxs = []int32{
	150, // 0: nakama.console.Account.account:type_name -> nakama.api.Account
	151, // 1: nakama.console.Account.disable_time:type_name -> google.protobuf.Timestamp
	152, // 2: nakama.console.AccountDeleteRequest.record_deletion:type_name -> google.protobuf.BoolValue
	150, // 3: nakama.console.AccountExport.account:type_name -> nakama.api.Account
	153, // 4: nakama.console.AccountExport.objects:type_name -> nakama.api.StorageObject
	154, // 5: nakama.console.AccountExport.friends:type_name -> nakama.api.Friend
	155, // 6: nakama.console.AccountExport.groups:type_name -> nakama.api.Group
	156, // 7: nakama.console.AccountExport.messages:type_name -> nakama.api.ChannelMessage
	157, // 8: nakama.console.AccountExport.leaderboard_records:type_name -> nakama.api.LeaderboardRecord
	158, // 9: nakama.console.AccountExport.notifications:type_name -> nakama.api.Notification
	...
	159, // 12: nakama.console.AccountList.users:type_name -> nakama.api.User
	160, // 13: nakama.console.AuditLogRequest.resource:type_name -> google.protobuf.Int32Value
	4,   // 14: nakama.console.AuditLogRequest.action:type_name -> nakama.console.AuditLogAction
	151, // 15: nakama.console.AuditLogRequest.after:type_name -> google.protobuf.Timestamp
	151, // 16: nakama.console.AuditLogRequest.before:type_name -> google.protobuf.Timestamp
	115, // 17: nakama.console.AuditLogList.entries:type_name -> nakama.console.AuditLogList.AuditLog
	155, // 18: nakama.console.GroupList.groups:type_name -> nakama.api.Group
	155, // 19: nakama.console.GroupExport.group:type_name -> nakama.api.Group
	161, // 20: nakama.console.GroupExport.members:type_name -> nakama.api.GroupUserList.GroupUser
	...
	151, // 27: nakama.console.AclTemplate.create_time:type_name -> google.protobuf.Timestamp
	151, // 28: nakama.console.AclTemplate.update_time:type_name -> google.protobuf.Timestamp
	151, // 29: nakama.console.AccountNote.create_time:type_name -> google.protobuf.Timestamp
	151, // 30: nakama.console.AccountNote.update_time:type_name -> google.protobuf.Timestamp
	...
	162, // 37: nakama.console.ConsoleSession.mfa_code:type_name -> google.protobuf.StringValue
	151, // 38: nakama.console.DeleteChannelMessagesRequest.before:type_name -> google.protobuf.Timestamp
	123, // 39: nakama.console.Extensions.hiro_systems:type_name -> nakama.console.Extensions.HiroSystems
	151, // 40: nakama.console.Leaderboard.create_time:type_name -> google.protobuf.Timestamp
	151, // 41: nakama.console.Leaderboard.start_time:type_name -> google.protobuf.Timestamp
	151, // 42: nakama.console.Leaderboard.end_time:type_name -> google.protobuf.Timestamp
	...
	160, // 45: nakama.console.ListMatchesRequest.limit:type_name -> google.protobuf.Int32Value
	152, // 46: nakama.console.ListMatchesRequest.authoritative:type_name -> google.protobuf.BoolValue
	162, // 47: nakama.console.ListMatchesRequest.label:type_name -> google.protobuf.StringValue
	160, // 48: nakama.console.ListMatchesRequest.min_size:type_name -> google.protobuf.Int32Value
	160, // 49: nakama.console.ListMatchesRequest.max_size:type_name -> google.protobuf.Int32Value
	162, // 50: nakama.console.ListMatchesRequest.query:type_name -> google.protobuf.StringValue
	162, // 51: nakama.console.ListMatchesRequest.node:type_name -> google.protobuf.StringValue
	151, // 52: nakama.console.ListPurchasesRequest.after:type_name -> google.protobuf.Timestamp
	151, // 53: nakama.console.ListPurchasesRequest.before:type_name -> google.protobuf.Timestamp
	151, // 54: nakama.console.ListSubscriptionsRequest.after:type_name -> google.protobuf.Timestamp
	151, // 55: nakama.console.ListSubscriptionsRequest.before:type_name -> google.protobuf.Timestamp
	163, // 56: nakama.console.MatchState.presences:type_name -> nakama.realtime.UserPresence
	151, // 57: nakama.console.Notification.create_time:type_name -> google.protobuf.Timestamp
	...
	162, // 61: nakama.console.UpdateAccountRequest.username:type_name -> google.protobuf.StringValue
	162, // 62: nakama.console.UpdateAccountRequest.display_name:type_name -> google.protobuf.StringValue
	162, // 63: nakama.console.UpdateAccountRequest.metadata:type_name -> google.protobuf.StringValue
	162, // 64: nakama.console.UpdateAccountRequest.avatar_url:type_name -> google.protobuf.StringValue
	162, // 65: nakama.console.UpdateAccountRequest.lang_tag:type_name -> google.protobuf.StringValue
	162, // 66: nakama.console.UpdateAccountRequest.location:type_name -> google.protobuf.StringValue
	162, // 67: nakama.console.UpdateAccountRequest.timezone:type_name -> google.protobuf.StringValue
	162, // 68: nakama.console.UpdateAccountRequest.custom_id:type_name -> google.protobuf.StringValue
	162, // 69: nakama.console.UpdateAccountRequest.email:type_name -> google.protobuf.StringValue
	162, // 70: nakama.console.UpdateAccountRequest.password:type_name -> google.protobuf.StringValue
	124, // 71: nakama.console.UpdateAccountRequest.device_ids:type_name -> nakama.console.UpdateAccountRequest.DeviceIdsEntry
	162, // 72: nakama.console.UpdateAccountRequest.wallet:type_name -> google.protobuf.StringValue
	162, // 73: nakama.console.UpdateGroupRequest.name:type_name -> google.protobuf.StringValue
	162, // 74: nakama.console.UpdateGroupRequest.description:type_name -> google.protobuf.StringValue
	162, // 75: nakama.console.UpdateGroupRequest.lang_tag:type_name -> google.protobuf.StringValue
	162, // 76: nakama.console.UpdateGroupRequest.metadata:type_name -> google.protobuf.StringValue
	162, // 77: nakama.console.UpdateGroupRequest.avatar_url:type_name -> google.protobuf.StringValue
	152, // 78: nakama.console.UpdateGroupRequest.open:type_name -> google.protobuf.BoolValue
	160, // 79: nakama.console.UpdateGroupRequest.max_count:type_name -> google.protobuf.Int32Value
	125, // 80: nakama.console.User.acl:type_name -> nakama.console.User.AclEntry
	151, // 81: nakama.console.User.create_time:type_name -> google.protobuf.Timestamp
	151, // 82: nakama.console.User.update_time:type_name -> google.protobuf.Timestamp
	...
	151, // 85: nakama.console.StatusList.timestamp:type_name -> google.protobuf.Timestamp
	127, // 86: nakama.console.RuntimeInfo.go_modules:type_name -> nakama.console.RuntimeInfo.ModuleInfo
	127, // 87: nakama.console.RuntimeInfo.lua_modules:type_name -> nakama.console.RuntimeInfo.ModuleInfo
	127, // 88: nakama.console.RuntimeInfo.js_modules:type_name -> nakama.console.RuntimeInfo.ModuleInfo
	151, // 89: nakama.console.WalletLedger.create_time:type_name -> google.protobuf.Timestamp
	151, // 90: nakama.console.WalletLedger.update_time:type_name -> google.protobuf.Timestamp
	87,  // 91: nakama.console.WalletLedgerList.items:type_name -> nakama.console.WalletLedger
	160, // 92: nakama.console.WriteStorageObjectRequest.permission_read:type_name -> google.protobuf.Int32Value
	160, // 93: nakama.console.WriteStorageObjectRequest.permission_write:type_name -> google.protobuf.Int32Value
	151, // 94: nakama.console.GetWalletLedgerRequest.after:type_name -> google.protobuf.Timestamp
	151, // 95: nakama.console.GetWalletLedgerRequest.before:type_name -> google.protobuf.Timestamp
	151, // 96: nakama.console.StorageListObject.create_time:type_name -> google.protobuf.Timestamp
	151, // 97: nakama.console.StorageListObject.update_time:type_name -> google.protobuf.Timestamp
	153, // 98: nakama.console.StorageIndexList.objects:type_name -> nakama.api.StorageObject
	96,  // 99: nakama.console.SettingList.settings:type_name -> nakama.console.Setting
	3,   // 100: nakama.console.SettingList.acl_resources:type_name -> nakama.console.AclResources
	128, // 101: nakama.console.UpdateUserRequest.acl:type_name -> nakama.console.UpdateUserRequest.AclEntry
	164, // 102: nakama.console.SendNotificationRequest.content:type_name -> google.protobuf.Struct
	105, // 103: nakama.console.Template.variants:type_name -> nakama.console.TemplateVariant
	142, // 104: nakama.console.Template.categories:type_name -> nakama.console.Category.View
	1,   // 105: nakama.console.SendDirectMessageRequest.integrations:type_name -> nakama.console.MessageIntegrationType
	143, // 106: nakama.console.SendDirectMessageRequest.channels:type_name -> nakama.console.SendDirectMessageRequest.ChannelsEntry
	144, // 107: nakama.console.SendDirectMessageRequest.template_override:type_name -> nakama.console.SendDirectMessageRequest.TemplateOverride
	147, // 108: nakama.console.SendDirectMessageResponse.delivery_results:type_name -> nakama.console.SendDirectMessageResponse.DeliveryResult
	1,   // 109: nakama.console.MessageIntegration.type:type_name -> nakama.console.MessageIntegrationType
	110, // 110: nakama.console.MessageIntegration.apns:type_name -> nakama.console.AppleMessageConfiguration
	111, // 111: nakama.console.MessageIntegration.fcm:type_name -> nakama.console.FirebaseMessagingConfiguration
	112, // 112: nakama.console.MessageIntegration.facebook_notification:type_name -> nakama.console.FacebookNotificationConfiguration
	113, // 113: nakama.console.MessageIntegration.onesignal_notification:type_name -> nakama.console.OneSignalNotificationConfiguration
	6,   // 114: nakama.console.AppleMessageConfiguration.env:type_name -> nakama.console.AppleMessageConfiguration.EnvType
	151, // 115: nakama.console.AuditLogList.AuditLog.timestamp:type_name -> google.protobuf.Timestamp
	3,   // 116: nakama.console.AuditLogList.AuditLog.resource:type_name -> nakama.console.AclResources
	4,   // 117: nakama.console.AuditLogList.AuditLog.action:type_name -> nakama.console.AuditLogAction
	165, // 118: nakama.console.MatchList.Match.api_match:type_name -> nakama.api.Match
	114, // 119: nakama.console.AddUserRequest.AclEntry.value:type_name -> nakama.console.Permissions
	114, // 120: nakama.console.AddAclTemplateRequest.AclEntry.value:type_name -> nakama.console.Permissions
	114, // 121: nakama.console.UpdateAclTemplateRequest.AclEntry.value:type_name -> nakama.console.Permissions
	114, // 122: nakama.console.AclTemplate.AclEntry.value:type_name -> nakama.console.Permissions
	114, // 123: nakama.console.User.AclEntry.value:type_name -> nakama.console.Permissions
	0,   // 124: nakama.console.StatusList.Status.health:type_name -> nakama.console.StatusHealth
	151, // 125: nakama.console.StatusList.Status.create_time:type_name -> google.protobuf.Timestamp
	151, // 126: nakama.console.RuntimeInfo.ModuleInfo.mod_time:type_name -> google.protobuf.Timestamp
	114, // 127: nakama.console.UpdateUserRequest.AclEntry.value:type_name -> nakama.console.Permissions
	142, // 128: nakama.console.Template.View.categories:type_name -> nakama.console.Category.View
	131, // 129: nakama.console.Template.Export.variants:type_name -> nakama.console.Template.VariantExport
	138, // 130: nakama.console.Template.ListRequest.search:type_name -> nakama.console.Template.ListRequest.SearchOptions
	140, // 131: nakama.console.Template.ListRequest.pagination:type_name -> nakama.console.Template.ListRequest.PaginationOptions
	129, // 132: nakama.console.Template.ListResponse.templates:type_name -> nakama.console.Template.View
	137, // 133: nakama.console.Template.ListResponse.page_options:type_name -> nakama.console.Template.PageOptions
	133, // 134: nakama.console.Template.ListRequest.SearchOptions.name:type_name -> nakama.console.Template.SingleTextValueFilterOption
	139, // 135: nakama.console.Template.ListRequest.SearchOptions.label_name:type_name -> nakama.console.Template.ListRequest.MultiTextValueFilterOption
	145, // 136: nakama.console.SendDirectMessageRequest.ChannelsEntry.value:type_name -> nakama.console.SendDirectMessageRequest.MessageChannels
	146, // 137: nakama.console.SendDirectMessageRequest.TemplateOverride.variants:type_name -> nakama.console.SendDirectMessageRequest.TemplateOverride.VariantsEntry
	2,   // 138: nakama.console.SendDirectMessageRequest.MessageChannels.channels:type_name -> nakama.console.MessageChannelType
	144, // 139: nakama.console.SendDirectMessageRequest.TemplateOverride.VariantsEntry.value:type_name -> nakama.console.SendDirectMessageRequest.TemplateOverride
	148, // 140: nakama.console.SendDirectMessageResponse.DeliveryResult.integration_results:type_name -> nakama.console.SendDirectMessageResponse.DeliveryResult.IntegrationResult
	...
	166, // 152: nakama.console.Console.ListAclTemplates:input_type -> google.protobuf.Empty
	...
	82,  // 156: nakama.console.Console.ResetUserPassword:input_type -> nakama.console.Username
	...
	166, // 161: nakama.console.Console.DeleteAllData:input_type -> google.protobuf.Empty
	...
	166, // 167: nakama.console.Console.DeleteStorage:input_type -> google.protobuf.Empty
	55,  // 168: nakama.console.Console.DeleteStorageObject:input_type -> nakama.console.DeleteStorageObjectRequest
	166, // 169: nakama.console.Console.DeleteAccounts:input_type -> google.protobuf.Empty
	...
	82,  // 173: nakama.console.Console.DeleteUser:input_type -> nakama.console.Username
	...
	166, // 181: nakama.console.Console.GetConfig:input_type -> google.protobuf.Empty
	...
	166, // 188: nakama.console.Console.GetRuntime:input_type -> google.protobuf.Empty
	97,  // 189: nakama.console.Console.GetSetting:input_type -> nakama.console.SettingRequest
	166, // 190: nakama.console.Console.GetStatus:input_type -> google.protobuf.Empty
	167, // 191: nakama.console.Console.GetStorage:input_type -> nakama.api.ReadStorageObjectId
	82,  // 192: nakama.console.Console.GetUser:input_type -> nakama.console.Username
	90,  // 193: nakama.console.Console.GetWalletLedger:input_type -> nakama.console.GetWalletLedgerRequest
	91,  // 194: nakama.console.Console.GetNotification:input_type -> nakama.console.GetNotificationRequest
	92,  // 195: nakama.console.Console.GetPurchase:input_type -> nakama.console.GetPurchaseRequest
	93,  // 196: nakama.console.Console.GetSubscription:input_type -> nakama.console.GetSubscriptionRequest
	14,  // 197: nakama.console.Console.ListAuditLogs:input_type -> nakama.console.AuditLogRequest
	166, // 198: nakama.console.Console.ListAuditLogsUsers:input_type -> google.protobuf.Empty
	166, // 199: nakama.console.Console.ListApiEndpoints:input_type -> google.protobuf.Empty
	168, // 200: nakama.console.Console.ListLeaderboardRecords:input_type -> nakama.api.ListLeaderboardRecordsRequest
	59,  // 201: nakama.console.Console.ListLeaderboards:input_type -> nakama.console.LeaderboardListRequest
	98,  // 202: nakama.console.Console.ListSettings:input_type -> nakama.console.ListSettingsRequest
	69,  // 203: nakama.console.Console.ListStorage:input_type -> nakama.console.ListStorageRequest
	166, // 204: nakama.console.Console.ListStorageCollections:input_type -> google.protobuf.Empty
	...
	166, // 211: nakama.console.Console.ListStorageIndexes:input_type -> google.protobuf.Empty
	68,  // 212: nakama.console.Console.ListSubscriptions:input_type -> nakama.console.ListSubscriptionsRequest
	166, // 213: nakama.console.Console.ListUsers:input_type -> google.protobuf.Empty
	48,  // 214: nakama.console.Console.PromoteGroupMember:input_type -> nakama.console.UpdateGroupUserStateRequest
	94,  // 215: nakama.console.Console.QueryStorageIndex:input_type -> nakama.console.QueryStorageIndexRequest
	52,  // 216: nakama.console.Console.RequireUserMfa:input_type -> nakama.console.RequireUserMfaRequest
	...
	79,  // 220: nakama.console.Console.UnlinkDevice:input_type -> nakama.console.UnlinkDeviceRequest
	12,  // 221: nakama.console.Console.UnlinkEmail:input_type -> nakama.console.AccountId
	12,  // 222: nakama.console.Console.UnlinkApple:input_type -> nakama.console.AccountId
	12,  // 223: nakama.console.Console.UnlinkFacebook:input_type -> nakama.console.AccountId
	12,  // 224: nakama.console.Console.UnlinkFacebookInstantGame:input_type -> nakama.console.AccountId
	12,  // 225: nakama.console.Console.UnlinkGameCenter:input_type -> nakama.console.AccountId
	12,  // 226: nakama.console.Console.UnlinkGoogle:input_type -> nakama.console.AccountId
	12,  // 227: nakama.console.Console.UnlinkSteam:input_type -> nakama.console.AccountId
	80,  // 228: nakama.console.Console.UpdateAccount:input_type -> nakama.console.UpdateAccountRequest
	81,  // 229: nakama.console.Console.UpdateGroup:input_type -> nakama.console.UpdateGroupRequest
	100, // 230: nakama.console.Console.UpdateSetting:input_type -> nakama.console.UpdateSettingRequest
	102, // 231: nakama.console.Console.UpdateUser:input_type -> nakama.console.UpdateUserRequest
	89,  // 232: nakama.console.Console.WriteStorageObject:input_type -> nakama.console.WriteStorageObjectRequest
	132, // 233: nakama.console.Console.SatoriListTemplates:input_type -> nakama.console.Template.ListRequest
	107, // 234: nakama.console.Console.SatoriSendDirectMessage:input_type -> nakama.console.SendDirectMessageRequest
	103, // 235: nakama.console.Console.SendNotification:input_type -> nakama.console.SendNotificationRequest
	166, // 236: nakama.console.Console.RegisteredExtensions:input_type -> google.protobuf.Empty
	43,  // 237: nakama.console.Console.Authenticate:output_type -> nakama.console.ConsoleSession
	166, // 238: nakama.console.Console.AuthenticateLogout:output_type -> google.protobuf.Empty
	37,  // 239: nakama.console.Console.AuthenticateMFASetup:output_type -> nakama.console.AuthenticateMFASetupResponse
	166, // 240: nakama.console.Console.AuthenticatePasswordChange:output_type -> google.protobuf.Empty
	28,  // 241: nakama.console.Console.AddAccountNote:output_type -> nakama.console.AccountNote
	32,  // 242: nakama.console.Console.ListAccountNotes:output_type -> nakama.console.ListAccountNotesResponse
	27,  // 243: nakama.console.Console.AddAclTemplate:output_type -> nakama.console.AclTemplate
	27,  // 244: nakama.console.Console.UpdateAclTemplate:output_type -> nakama.console.AclTemplate
	26,  // 245: nakama.console.Console.ListAclTemplates:output_type -> nakama.console.AclTemplateList
	166, // 246: nakama.console.Console.DeleteAclTemplate:output_type -> google.protobuf.Empty
	166, // 247: nakama.console.Console.DeleteAccountNote:output_type -> google.protobuf.Empty
	33,  // 248: nakama.console.Console.AddUser:output_type -> nakama.console.AddUserResponse
	51,  // 249: nakama.console.Console.ResetUserPassword:output_type -> nakama.console.ResetUserResponse
	166, // 250: nakama.console.Console.AddGroupUsers:output_type -> google.protobuf.Empty
	166, // 251: nakama.console.Console.BanAccount:output_type -> google.protobuf.Empty
	...
	166, // 254: nakama.console.Console.DeleteAllData:output_type -> google.protobuf.Empty
	166, // 255: nakama.console.Console.DeleteAccount:output_type -> google.protobuf.Empty
	74,  // 256: nakama.console.Console.DeleteChannelMessages:output_type -> nakama.console.DeleteChannelMessagesResponse
	166, // 257: nakama.console.Console.DeleteFriend:output_type -> google.protobuf.Empty
	166, // 258: nakama.console.Console.DeleteGroup:output_type -> google.protobuf.Empty
	166, // 259: nakama.console.Console.DeleteGroupUser:output_type -> google.protobuf.Empty
	166, // 260: nakama.console.Console.DeleteStorage:output_type -> google.protobuf.Empty
	166, // 261: nakama.console.Console.DeleteStorageObject:output_type -> google.protobuf.Empty
	166, // 262: nakama.console.Console.DeleteAccounts:output_type -> google.protobuf.Empty
	166, // 263: nakama.console.Console.DeleteLeaderboard:output_type -> google.protobuf.Empty
	166, // 264: nakama.console.Console.DeleteLeaderboardRecord:output_type -> google.protobuf.Empty
	166, // 265: nakama.console.Console.DeleteNotification:output_type -> google.protobuf.Empty
	166, // 266: nakama.console.Console.DeleteUser:output_type -> google.protobuf.Empty
	166, // 267: nakama.console.Console.DeleteWalletLedger:output_type -> google.protobuf.Empty
	166, // 268: nakama.console.Console.DemoteGroupMember:output_type -> google.protobuf.Empty
	10,  // 269: nakama.console.Console.ExportAccount:output_type -> nakama.console.AccountExport
	166, // 270: nakama.console.Console.ImportAccount:output_type -> google.protobuf.Empty
	8,   // 271: nakama.console.Console.ImportAccountFull:output_type -> nakama.console.Account
	19,  // 272: nakama.console.Console.ExportGroup:output_type -> nakama.console.GroupExport
	8,   // 273: nakama.console.Console.GetAccount:output_type -> nakama.console.Account
	42,  // 274: nakama.console.Console.GetConfig:output_type -> nakama.console.Config
	169, // 275: nakama.console.Console.GetFriends:output_type -> nakama.api.FriendList
	155, // 276: nakama.console.Console.GetGroup:output_type -> nakama.api.Group
	170, // 277: nakama.console.Console.GetMembers:output_type -> nakama.api.GroupUserList
	171, // 278: nakama.console.Console.GetGroups:output_type -> nakama.api.UserGroupList
	...
	86,  // 281: nakama.console.Console.GetRuntime:output_type -> nakama.console.RuntimeInfo
	96,  // 282: nakama.console.Console.GetSetting:output_type -> nakama.console.Setting
	85,  // 283: nakama.console.Console.GetStatus:output_type -> nakama.console.StatusList
	153, // 284: nakama.console.Console.GetStorage:output_type -> nakama.api.StorageObject
	83,  // 285: nakama.console.Console.GetUser:output_type -> nakama.console.User
	88,  // 286: nakama.console.Console.GetWalletLedger:output_type -> nakama.console.WalletLedgerList
	72,  // 287: nakama.console.Console.GetNotification:output_type -> nakama.console.Notification
	172, // 288: nakama.console.Console.GetPurchase:output_type -> nakama.api.ValidatedPurchase
	173, // 289: nakama.console.Console.GetSubscription:output_type -> nakama.api.ValidatedSubscription
	16,  // 290: nakama.console.Console.ListAuditLogs:output_type -> nakama.console.AuditLogList
	15,  // 291: nakama.console.Console.ListAuditLogsUsers:output_type -> nakama.console.AuditLogUsersList
	34,  // 292: nakama.console.Console.ListApiEndpoints:output_type -> nakama.console.ApiEndpointList
	174, // 293: nakama.console.Console.ListLeaderboardRecords:output_type -> nakama.api.LeaderboardRecordList
	60,  // 294: nakama.console.Console.ListLeaderboards:output_type -> nakama.console.LeaderboardList
	101, // 295: nakama.console.Console.ListSettings:output_type -> nakama.console.SettingList
	75,  // 296: nakama.console.Console.ListStorage:output_type -> nakama.console.StorageList
	78,  // 297: nakama.console.Console.ListStorageCollections:output_type -> nakama.console.StorageCollectionsList
	13,  // 298: nakama.console.Console.ListAccounts:output_type -> nakama.console.AccountList
	175, // 299: nakama.console.Console.ListChannelMessages:output_type -> nakama.api.ChannelMessageList
	18,  // 300: nakama.console.Console.ListGroups:output_type -> nakama.console.GroupList
	73,  // 301: nakama.console.Console.ListNotifications:output_type -> nakama.console.NotificationList
	20,  // 302: nakama.console.Console.ListMatches:output_type -> nakama.console.MatchList
	176, // 303: nakama.console.Console.ListPurchases:output_type -> nakama.api.PurchaseList
	76,  // 304: nakama.console.Console.ListStorageIndexes:output_type -> nakama.console.StorageIndexesList
	177, // 305: nakama.console.Console.ListSubscriptions:output_type -> nakama.api.SubscriptionList
	84,  // 306: nakama.console.Console.ListUsers:output_type -> nakama.console.UserList
	166, // 307: nakama.console.Console.PromoteGroupMember:output_type -> google.protobuf.Empty
	99,  // 308: nakama.console.Console.QueryStorageIndex:output_type -> nakama.console.StorageIndexList
	166, // 309: nakama.console.Console.RequireUserMfa:output_type -> google.protobuf.Empty
	166, // 310: nakama.console.Console.ResetUserMfa:output_type -> google.protobuf.Empty
	166, // 311: nakama.console.Console.UnbanAccount:output_type -> google.protobuf.Empty
	166, // 312: nakama.console.Console.UnlinkCustom:output_type -> google.protobuf.Empty
	166, // 313: nakama.console.Console.UnlinkDevice:output_type -> google.protobuf.Empty
	166, // 314: nakama.console.Console.UnlinkEmail:output_type -> google.protobuf.Empty
	166, // 315: nakama.console.Console.UnlinkApple:output_type -> google.protobuf.Empty
	166, // 316: nakama.console.Console.UnlinkFacebook:output_type -> google.protobuf.Empty
	166, // 317: nakama.console.Console.UnlinkFacebookInstantGame:output_type -> google.protobuf.Empty
	166, // 318: nakama.console.Console.UnlinkGameCenter:output_type -> google.protobuf.Empty
	166, // 319: nakama.console.Console.UnlinkGoogle:output_type -> google.protobuf.Empty
	166, // 320: nakama.console.Console.UnlinkSteam:output_type -> google.protobuf.Empty
	166, // 321: nakama.console.Console.UpdateAccount:output_type -> google.protobuf.Empty
	166, // 322: nakama.console.Console.UpdateGroup:output_type -> google.protobuf.Empty
	96,  // 323: nakama.console.Console.UpdateSetting:output_type -> nakama.console.Setting
	83,  // 324: nakama.console.Console.UpdateUser:output_type -> nakama.console.User
	178, // 325: nakama.console.Console.WriteStorageObject:output_type -> nakama.api.StorageObjectAck
	134, // 326: nakama.console.Console.SatoriListTemplates:output_type -> nakama.console.Template.ListResponse
	108, // 327: nakama.console.Console.SatoriSendDirectMessage:output_type -> nakama.console.SendDirectMessageResponse
	166, // 328: nakama.console.Console.SendNotification:output_type -> google.protobuf.Empty
	57,  // 329: nakama.console.Console.RegisteredExtensions:output_type -> nakama.console.Extensions
	237, // [237:330] is the sub-list for method output_type
	144, // [144:237] is the sub-list for method input_type
