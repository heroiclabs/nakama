...
func (*GetAchievementRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9289ac5ba895f2a7, []int{21}
}

func (m *GetAchievementRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetAchievementRequest.Unmarshal(m, b)
}
...
func (m *GetAchievementRequest) XXX_Size() int {
	return xxx_messageInfo_GetAchievementRequest.Size(m)
}
...
func (m *GetAchievementRequest) GetAchievementId() string {
	if m != nil {
...
type AchievementCreationRequest struct {
	// The name of the achievement.
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Description of the achievement.
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	// The state in which the achievement starts out.
	InitialState *wrappers.Int32Value `protobuf:"bytes,3,opt,name=initial_state,json=initialState,proto3" json:"initial_state,omitempty"`
	// Whether the achievement is awarded manually or progressed towards.
	Type *wrappers.Int32Value `protobuf:"bytes,4,opt,name=type,proto3" json:"type,omitempty"`
	// Whether an achievement can be earned multiple times. Currently only non-repeatable are supported.
	Repeatability *wrappers.Int32Value `protobuf:"bytes,5,opt,name=repeatability,proto3" json:"repeatability,omitempty"`
	...
	LockedImageUrl string `protobuf:"bytes,7,opt,name=locked_image_url,json=lockedImageUrl,proto3" json:"locked_image_url,omitempty"`
	// URL for the image to be shown once the achievement was unlocked.
	UnlockedImageUrl string `protobuf:"bytes,8,opt,name=unlocked_image_url,json=unlockedImageUrl,proto3" json:"unlocked_image_url,omitempty"`
	// Auxiliary data field, which may be used by developers to store custom data.
	AuxiliaryData        string   `protobuf:"bytes,9,opt,name=auxiliary_data,json=auxiliaryData,proto3" json:"auxiliary_data,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *AchievementCreationRequest) Reset()         { *m = AchievementCreationRequest{} }
func (m *AchievementCreationRequest) String() string { return proto.CompactTextString(m) }
func (*AchievementCreationRequest) ProtoMessage()    {}
func (*AchievementCreationRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_9289ac5ba895f2a7, []int{22}
}

func (m *AchievementCreationRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AchievementCreationRequest.Unmarshal(m, b)
}
func (m *AchievementCreationRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AchievementCreationRequest.Marshal(b, m, deterministic)
}
func (m *AchievementCreationRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AchievementCreationRequest.Merge(m, src)
}
func (m *AchievementCreationRequest) XXX_Size() int {
	return xxx_messageInfo_AchievementCreationRequest.Size(m)
}
func (m *AchievementCreationRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_AchievementCreationRequest.DiscardUnknown(m)
}

var xxx_messageInfo_AchievementCreationRequest proto.InternalMessageInfo

func (m *AchievementCreationRequest) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *AchievementCreationRequest) GetDescription() string {
	if m != nil {
...
func (m *AchievementCreationRequest) GetInitialState() *wrappers.Int32Value {
	if m != nil {
...
func (m *AchievementCreationRequest) GetType() *wrappers.Int32Value {
	if m != nil {
		return m.Type
	}
	return nil
...
func (m *AchievementCreationRequest) GetRepeatability() *wrappers.Int32Value {
	if m != nil {
...
func (m *AchievementCreationRequest) GetTargetValue() int64 {
	if m != nil {
...
func (m *AchievementCreationRequest) GetLockedImageUrl() string {
	if m != nil {
...
func (m *AchievementCreationRequest) GetUnlockedImageUrl() string {
	if m != nil {
...
func (m *AchievementCreationRequest) GetAuxiliaryData() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*GetAchievementRequest)(nil), "nakama.console.GetAchievementRequest")
	proto.RegisterType((*AchievementCreationRequest)(nil), "nakama.console.AchievementCreationRequest")
}
...
var fileDescriptor_9289ac5ba895f2a7 = []byte{
	...
	,
}
...
type ConsoleClient interface {
	...
	ListAchievements(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*api.Achievements, error)
	// Get a specific achievement by its UUID.
	GetAchievement(ctx context.Context, in *GetAchievementRequest, opts ...grpc.CallOption) (*api.Achievement, error)
	// Create a new achievement.
	CreateAchievement(ctx context.Context, in *AchievementCreationRequest, opts ...grpc.CallOption) (*api.Achievement, error)
	// Modify existing achievement.
	ModifyAchievement(ctx context.Context, in *api.Achievement, opts ...grpc.CallOption) (*api.Achievement, error)
	// Delete an existing achievement.
	DeleteAchievement(ctx context.Context, in *api.Achievement, opts ...grpc.CallOption) (*empty.Empty, error)
	// Set a users progress towards an achievement.
	SetUserAchievementProgress(ctx context.Context, in *api.AchievementProgress, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *consoleClient) ListAchievements(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*api.Achievements, error) {
	out := new(api.Achievements)
	err := c.cc.Invoke(ctx, "/nakama.console.Console/ListAchievements", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) GetAchievement(ctx context.Context, in *GetAchievementRequest, opts ...grpc.CallOption) (*api.Achievement, error) {
	out := new(api.Achievement)
	err := c.cc.Invoke(ctx, "/nakama.console.Console/GetAchievement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) CreateAchievement(ctx context.Context, in *AchievementCreationRequest, opts ...grpc.CallOption) (*api.Achievement, error) {
	out := new(api.Achievement)
	err := c.cc.Invoke(ctx, "/nakama.console.Console/CreateAchievement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) ModifyAchievement(ctx context.Context, in *api.Achievement, opts ...grpc.CallOption) (*api.Achievement, error) {
	out := new(api.Achievement)
	err := c.cc.Invoke(ctx, "/nakama.console.Console/ModifyAchievement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) DeleteAchievement(ctx context.Context, in *api.Achievement, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/nakama.console.Console/DeleteAchievement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) SetUserAchievementProgress(ctx context.Context, in *api.AchievementProgress, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/nakama.console.Console/SetUserAchievementProgress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConsoleServer interface {
	...
	// List all achievements.
	ListAchievements(context.Context, *empty.Empty) (*api.Achievements, error)
	// Get a specific achievement by its UUID.
	GetAchievement(context.Context, *GetAchievementRequest) (*api.Achievement, error)
	// Create a new achievement.
	CreateAchievement(context.Context, *AchievementCreationRequest) (*api.Achievement, error)
	// Modify existing achievement.
	ModifyAchievement(context.Context, *api.Achievement) (*api.Achievement, error)
	// Delete an existing achievement.
	DeleteAchievement(context.Context, *api.Achievement) (*empty.Empty, error)
	// Set a users progress towards an achievement.
	SetUserAchievementProgress(context.Context, *api.AchievementProgress) (*empty.Empty, error)
}
...
func (*UnimplementedConsoleServer) ListAchievements(ctx context.Context, req *empty.Empty) (*api.Achievements, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListAchievements not implemented")
}
func (*UnimplementedConsoleServer) GetAchievement(ctx context.Context, req *GetAchievementRequest) (*api.Achievement, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAchievement not implemented")
}
func (*UnimplementedConsoleServer) CreateAchievement(ctx context.Context, req *AchievementCreationRequest) (*api.Achievement, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAchievement not implemented")
}
func (*UnimplementedConsoleServer) ModifyAchievement(ctx context.Context, req *api.Achievement) (*api.Achievement, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ModifyAchievement not implemented")
}
func (*UnimplementedConsoleServer) DeleteAchievement(ctx context.Context, req *api.Achievement) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteAchievement not implemented")
}
func (*UnimplementedConsoleServer) SetUserAchievementProgress(ctx context.Context, req *api.AchievementProgress) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetUserAchievementProgress not implemented")
}
...
func _Console_ListAchievements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsoleServer).ListAchievements(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/ListAchievements",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsoleServer).ListAchievements(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

func _Console_GetAchievement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetAchievementRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsoleServer).GetAchievement(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/GetAchievement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsoleServer).GetAchievement(ctx, req.(*GetAchievementRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Console_CreateAchievement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AchievementCreationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsoleServer).CreateAchievement(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/CreateAchievement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsoleServer).CreateAchievement(ctx, req.(*AchievementCreationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Console_ModifyAchievement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.Achievement)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsoleServer).ModifyAchievement(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/ModifyAchievement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsoleServer).ModifyAchievement(ctx, req.(*api.Achievement))
	}
	return interceptor(ctx, in, info, handler)
}

func _Console_DeleteAchievement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.Achievement)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsoleServer).DeleteAchievement(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/DeleteAchievement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsoleServer).DeleteAchievement(ctx, req.(*api.Achievement))
	}
	return interceptor(ctx, in, info, handler)
}

func _Console_SetUserAchievementProgress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(api.AchievementProgress)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConsoleServer).SetUserAchievementProgress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/SetUserAchievementProgress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConsoleServer).SetUserAchievementProgress(ctx, req.(*api.AchievementProgress))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Console_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Console_ListAchievements_Handler,
		},
		{
			MethodName: "GetAchievement",
			Handler:    _Console_GetAchievement_Handler,
		},
		{
			MethodName: "CreateAchievement",
			Handler:    _Console_CreateAchievement_Handler,
		},
		{
			MethodName: "ModifyAchievement",
			Handler:    _Console_ModifyAchievement_Handler,
		},
		{
			MethodName: "DeleteAchievement",
			Handler:    _Console_DeleteAchievement_Handler,
		},
		{
			MethodName: "SetUserAchievementProgress",
			Handler:    _Console_SetUserAchievementProgress_Handler,
		},
	},
