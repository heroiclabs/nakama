...
func (c *consoleClient) AuthenticatePasswordChange(ctx context.Context, in *AuthenticatePasswordChangeRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/nakama.console.Console/AuthenticatePasswordChange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) ListStorageIndexes(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StorageIndexesList, error) {
	...
	err := c.cc.Invoke(ctx, "/nakama.console.Console/ListStorageIndexes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) QueryStorageIndex(ctx context.Context, in *QueryStorageIndexRequest, opts ...grpc.CallOption) (*StorageIndexList, error) {
	...
	err := c.cc.Invoke(ctx, "/nakama.console.Console/QueryStorageIndex", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) SatoriListTemplates(ctx context.Context, in *Template_ListRequest, opts ...grpc.CallOption) (*Template_ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nakama.console.Console/SatoriListTemplates", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) SatoriSendDirectMessage(ctx context.Context, in *SendDirectMessageRequest, opts ...grpc.CallOption) (*SendDirectMessageResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nakama.console.Console/SatoriSendDirectMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *consoleClient) RegisteredExtensions(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Extensions, error) {
	out := new(Extensions)
	err := c.cc.Invoke(ctx, "/nakama.console.Console/RegisteredExtensions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Console_AuthenticatePasswordChange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/AuthenticatePasswordChange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Console_ListStorageIndexes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/ListStorageIndexes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Console_QueryStorageIndex_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/QueryStorageIndex",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Console_SatoriListTemplates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/SatoriListTemplates",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Console_SatoriSendDirectMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/SatoriSendDirectMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Console_RegisteredExtensions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nakama.console.Console/RegisteredExtensions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
