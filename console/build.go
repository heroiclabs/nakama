...
//go:generate protoc -I . -I ../vendor -I ../vendor/github.com/heroiclabs/nakama-common -I ../build/grpc-gateway-v2.3.0/third_party/googleapis -I ../vendor/github.com/grpc-ecosystem/grpc-gateway/v2 --go_out=. --go_opt=paths=source_relative --openapiv2_out=. --openapiv2_opt=allow_merge=true,merge_file_name=console_nakama,json_names_for_fields=false,simple_operation_ids=true,disable_service_tags=true,openapi_naming_strategy=simple console.proto
