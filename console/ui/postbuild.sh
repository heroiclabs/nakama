...
# Replace prepend /static to hardcoded paths for .css and .js files in generated Angular index.html files
# Required due to the deprecation of deployUrl config in Angular
